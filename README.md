...
- The remaining hyperlink-migration work is now downstream of Requests and shared search/details: Exports, Bank Ledger item rows, final docs cleanup, and live `/reload` verification around anchor item `244559` still need to be finished.
