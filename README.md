...
- Routine scan and accepted-sync chat chatter can now be muted from `Options -> Appearance -> Suppress Routine Chat`; warnings, errors, explicit debug slash output, and in-game test output remain visible.
