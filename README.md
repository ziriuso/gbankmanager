...
- Guild sync foundation with authority-first conflict resolution, canonical `Character-Server` peer identity, compact inbound sync chat milestones, and reconstructed local History rows for accepted remote request/minimum changes that already belong in the History tab
