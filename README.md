...
1. Continue the shelved UI polish refinement pass from [docs/ui-polish-suggestions.md](docs/ui-polish-suggestions.md), now building on the landed shell-polish checkpoint. The next step is still the addon-local art pack for closer mockup fidelity, not another round of ad hoc frame-only ornament.
