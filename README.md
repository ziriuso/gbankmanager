...
- The v1.2.3 money-ledger guard runs once for clients that have not yet recorded `meta.moneyLedgerDedupedForVersion = 1.2.3`; it removes duplicate money-log rows created from the same visible Blizzard money entry, clears polluted money-ledger caches, and preserves item ledger rows.
