...
assert.truthy(string.find(mainFrame.aboutVersionText:GetText() or "", "forever-v1.6.0-beta.1", 1, true) ~= nil, "about should show the latest Forever release identifier")
