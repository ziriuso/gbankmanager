...
assert.truthy(string.find(mainFrame.aboutVersionText:GetText() or "", "Version forever-v1.6.0 (", 1, true) ~= nil, "about should show the latest Forever release identifier")
