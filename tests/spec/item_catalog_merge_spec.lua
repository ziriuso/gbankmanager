...
local rebuiltTocText = read_text_file(refreshTocPath)
...
assert.truthy(rebuiltTocText:find("## Interface: 120100, 120007, 120005", 1, true) ~= nil, "refresh command should rebuild the item-data toc with the current supported interface versions")
...
assert.truthy(read_text_file(join_path(buildOnlyAddonDir, "GBankManager_ItemData.toc")):find("## Interface: 120100, 120007, 120005", 1, true) ~= nil, "build command should stamp the current supported interface versions into the generated item-data toc")
