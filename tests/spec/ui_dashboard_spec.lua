...
env.ns.state.db.meta.guildBankBalanceCopper = 1
env.ns.state.db.meta.guildBankBalanceScannedAt = 1715523400
mainFrame:RefreshView()
assert.equal("Bank balance: 1c", mainFrame.dashboardCards[1].noteText:GetText(), "dashboard should show a scanned guild bank balance")
env.ns.state.db.meta.guildBankBalanceCopper = nil
env.ns.state.db.meta.guildBankBalanceScannedAt = nil
mainFrame:RefreshView()
