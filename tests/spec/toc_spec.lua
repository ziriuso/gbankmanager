...
assert.equal("## Version: 1.1.1", versionLine, "toc should advertise the current addon version for release metadata and the About panel")
assert.equal("## X-Release-Tag: v1.1.1", releaseTagLine, "toc should advertise the current tagged release for the About panel")
