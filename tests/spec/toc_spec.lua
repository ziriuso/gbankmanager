...
assert.equal("## Version: 1.4.1", versionLine, "toc should advertise the current addon version for release metadata and the About panel")
assert.equal("## X-Release-Tag: v1.4.1", releaseTagLine, "toc should advertise the current tagged release for the About panel")
...
assert.equal("1.4.1", mainNamespace.constants.ADDON_VERSION, "metadata-free addon loads should use the current release version fallback")
