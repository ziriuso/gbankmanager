...
assert.equal("Mute Silvermoon Citizen", mainFrame.optionsMuteSilvermoonCitizenToggle.labelText:GetText(), "logs/history settings should expose the Silvermoon Citizen mute toggle")
assert.truthy(mainFrame.optionsMuteSilvermoonCitizenToggle:GetChecked() ~= true, "logs/history settings should default the Silvermoon Citizen mute toggle off")
