...
assert.truthy((mainFrame.optionsAppearancePanel:GetHeight() or 0) >= 200, "appearance panel should stay tall enough to keep the minimap toggle and sliders inside the chrome")
assert.truthy((mainFrame.optionsAppearancePanel:GetHeight() or 0) <= 240, "appearance panel should not leave a large empty ghost box below the appearance controls")
