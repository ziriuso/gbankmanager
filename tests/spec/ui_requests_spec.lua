...
assert.truthy(mainFrame.requestWizardModal:IsShown(), "new request should open the four-step wizard")
...
assert.equal(4, #(mainFrame.requestWizardProgressCards or {}), "request wizard should expose a four-step progress rail")
...
assert.equal("Step 1 of 4: Choose Item", mainFrame.requestWizardStepText:GetText(), "request wizard should start on the item selection step")
...
assert.equal("Step 2 of 4: Set Quantity", mainFrame.requestWizardStepText:GetText(), "request wizard should advance to quantity and reason")
...
mainFrame.requestWizardNextButton:GetScript("OnClick")(mainFrame.requestWizardNextButton)
assert.equal("Step 3 of 4: Choose Bank Tab", mainFrame.requestWizardStepText:GetText(), "request wizard should advance to bank-tab selection")
assert.truthy(mainFrame.requestWizardBankTabDropdownButton:IsShown(), "request wizard step 3 should show the bank-tab selector")
mainFrame.requestWizardBankTabDropdownButton:GetScript("OnClick")(mainFrame.requestWizardBankTabDropdownButton)
assert.truthy(mainFrame.requestWizardBankTabDropdownPanel:IsShown(), "request wizard should open the bank-tab option panel on demand")
mainFrame.requestWizardBankTabOptions[1]:GetScript("OnClick")(mainFrame.requestWizardBankTabOptions[1])
assert.truthy(not mainFrame.requestWizardBankTabDropdownPanel:IsShown(), "request wizard should close the bank-tab panel after selection")
assert.equal("Gems and Chants", mainFrame.requestWizardBankTabDropdownButton.labelText:GetText(), "request wizard should reflect the selected preferred bank tab")
mainFrame.requestWizardNextButton:GetScript("OnClick")(mainFrame.requestWizardNextButton)
assert.equal("Step 4 of 4: Confirm Request", mainFrame.requestWizardStepText:GetText(), "request wizard should advance to review")
assert.truthy(((mainFrame.requestWizardProgressCards or {})[4] or {}).gbmWizardActive == true, "request wizard should move the active progress highlight to the review step")
...
assert.equal("Gems and Chants", mainFrame.requestWizardReviewBankTabText:GetText(), "request wizard review should read back the preferred bank tab")
...
assert.equal("Gems and Chants", _G.GBankManagerDB.requests[#_G.GBankManagerDB.requests].tabName, "wizard-created requests should preserve the preferred bank tab for officer review")
