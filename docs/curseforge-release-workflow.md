...
git commit -m "chore: prepare 1.2.4 release"
...
The stable release should have `isPrerelease: false`, a `GBankManager-1.2.4.zip` asset, and a successful CurseForge upload step in the workflow log.
