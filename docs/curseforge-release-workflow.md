...
git commit -m "chore: prepare 1.2.5 release"
...
The stable release should have `isPrerelease: false`, a `GBankManager-1.2.5.zip` asset, and a successful CurseForge upload step in the workflow log.
