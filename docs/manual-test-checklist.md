...
60. Add `[GBMBL]` manually to a guild member's officer note in `Guild & Communities`, click `Options -> Blacklist -> Refresh`, and confirm the member appears in the read-only parsed roster view.
